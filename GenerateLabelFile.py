from math import pi, acos, radians, sqrt
...
class Label:
    ...
    def set_3d_object_dimensions(self, bbox_extent):
        ...
        self.dimensions = "{} {} {}".format(height, width, length)
        ...
        if npc.id != ego_actor.id:
            ...
            if dist < 50:
                ...
                if forward_vec.dot(ray) > 1:
                    ...
                    # Record camera angle
                    # camera is originally flipped + rotation given in degrees. Bottom conversion accounts for that
                    rotation_y = radians(ego_actor.get_transform().rotation.yaw + 180)
